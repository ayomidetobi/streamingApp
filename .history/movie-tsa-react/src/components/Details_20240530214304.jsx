    ...
    <div className="container-fluid col-xxl-8 py-5 hero-details" style={{backgroundImage: `url(${(data.bg_img)})`}} >
        ...
        <div className="container-fluid mt-5 ps-5" >
            <div className="row">
                <div className="col-5">
                    <div className="">
                        <video width="500" height="300" src={data.video_file} title={dat} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></video>
                    </div>
                </div>
