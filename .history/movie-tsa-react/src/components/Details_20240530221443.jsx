        ...
        <div className="container-fluid mt-5 ps-5" >
            <div className="row">
                <div className="col-lg-6 col-sm-12">
                    <div className="">
                        <video  height="400" width={"100%"} className="" src={data.video_file} title={data.title} frameBorder="0"   allowfullscreen></video>
                    </div>
                </div>
                ...
                <div className="col-lg-6 col-sm-12 info">
                    <div className="">
                        ...
                        <div className="play fs-6 fs-sm-6">
                            ...
                            <button className='mx-3' type="button"><i className="bi bi-play-fill"></i> PLAY NOW</button>
                        </div>
